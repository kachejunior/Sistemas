	...
	<legend>Control de Entregas Realizadas</legend>
		...
		<div class="accordion" id="accordion2">
                <div class="accordion-group" style="border-color:#FFF ">
				  ...
				  <a href="<?php echo base_url().'salidas/nuevo'; ?>" class="btn-primary btn-small pull-right">
				  <i class="icon-plus-sign icon-white"></i> Crear nueva acta de salida</a>						
                  </div>
