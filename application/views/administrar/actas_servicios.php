<form class="span10 offset1">
	<!--<form class="span10 offset1" action="http://sistemas.fsbolivar.com.ve/servicios/buscar" method="post">-->
	<legend>Control de Servicios Prestados</legend>
		...
		<div class="accordion" id="accordion2">
                <div class="accordion-group" style="border-color:#FFF ">
				  ...
				  <a href="<?php echo base_url().'servicios/nuevo'; ?>" class="btn-primary btn-small pull-right">
				  <i class="icon-plus-sign icon-white"></i> Crear nuevo acta de servicio</a>						
                  </div>
                  <div id="collapseOne" class="accordion-body collapse" style="height: 0px;">
                    <div class="accordion-inner span12">
						<div class="control-group">
							...
							<div class="controls">
								<div class="input-prepend span3">
									<label>Fecha Inicio Sevicios</label>
							...
							<div class="controls">
								<div class="input-prepend span3">
									<label>Fecha Final Servicios</label>
									<span class="add-on"><i class="icon-calendar"></i></span>
		...
		<table id="tabla" class="table table-hover table-bordered table-striped">
			<thead>
				<tr style="background:#d44413; color: #FFF">
					...
					<th class="span2">Fecha de Servicio</th>
			...
			<tbody>
			<?php
			foreach ($actas_servicios as $row)
			{
				$str = '<tr>'.
					...
					'<td class="centrado">'.
						'<a class="btn btn-mini btn-warning" href="'.  base_url().'servicios/edicion/'.$row->id.'">'.
