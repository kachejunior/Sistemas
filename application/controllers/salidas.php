<?php class Salidas extends CI_Controller{
	...
	public function agregar()
	{
		...
		if($this->form_validation->run())
		{
			...
			echo $this->actas_salidas_model->agregar($fecha_entrega, $entregado_a, $nota, $id_gerencia, $id_sede, $cedula_usuario);
		}
		else
			echo '-10';
	}
	...
	public function editar()
	{
		...
		if($this->form_validation->run())
		{
			//echo 'bandera 1';
			 ...
			 $id_sede = $this->input->post('sede');
			 $cedula_usuario = $this->input->post('cedula');
			echo $this->actas_salidas_model->editar($fecha_servicio, $realizado_a, $detalle_servicio, $id_gerencia, $id_sede, $cedula_usuario);
		}
		else
			echo '-10';
	}
